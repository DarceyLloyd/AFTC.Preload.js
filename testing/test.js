...
// TODO: Fix why this doesn't work online but does offline
// function updateMassLoaderBoxes() {
//     var html = "";
...
var onCompleteHandler = function () {
    ...
    // Attach SVG to DOM
    var mySVG = myPreloader.getItemById("svg1");
...
function init() {
    ...
    // Dont load too many massive SVG files in as it slows even the best machines down
    for (var i = 1; i <= 3; i++) {
        svgUID = "svgTrace"+i;
